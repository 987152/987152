...
create a new file name addStudentMark make sure to check the file type is PHP, If you dont know how to change the file type copy index.php. paste the code below into the new file you create
