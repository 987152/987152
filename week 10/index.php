...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        // If the semester changes, print a new button (acting as a header)
        if ($current_semester != $row["semester_name"]) {
            ...
            // Update the current semester and print the semester name inside a button
            $current_semester = $row["semester_name"];
            echo "<button class='semester-button'>" . $current_semester . "</button>";
            echo "<table>
                    <tr>
                        <th>Course Code</th>
                        <th>Course Name</th>
